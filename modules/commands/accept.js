...
module.exports.handleReply = async ({ handleReply, event, api }) => {
  ...
  else return api.sendMessage("🟡- 𝘷𝘦𝘶𝘪𝘭𝘭𝘦𝘻 𝘳𝘦𝘱𝘳𝘦𝘯𝘥𝘳𝘦 𝘭𝘦 𝘮𝘦𝘴𝘴𝘢𝘨𝘦 𝘦𝘯 𝘤𝘩𝘰𝘪𝘴𝘪𝘴𝘴𝘢𝘯𝘵 <add | del > <so thu tu | 𝘰𝘶 \"all\">", event.threadID, event.messageID);
  ...
  for (const stt of targetIDs) {
    ...
    if (!u) {
      failed.push(`🔴- 𝘐𝘮𝘱𝘰𝘴𝘴𝘪𝘣𝘭𝘦 𝘥𝘦 𝘵𝘳𝘰𝘶𝘷𝘦𝘳 ${stt} 𝘥𝘢𝘯𝘴 𝘭𝘢 𝘭𝘪𝘴𝘵𝘦`);
      continue;
    }
